...
Dr. Newmark received his MD from Temple University (Katz) School of Medicine, completed an internal medicine internship at Drexel, anesthesiology residency at Harvard Medical School/Massachusetts General Hospital, and pain medicine fellowship at Stanford University where he served as Chief Fellow. He performs qualified medical evaluations (QME) and independent medical evaluations (IME) within California, utilizing the AMA Guides 5th edition.`,
  ...
  },
  {
    ...
    bio: `Dr. Jay Yasen is a board-certified vascular neurologist with more than 25 years of experience. He currently serves as Assistant Attending in Neurology and Director of Neurology Education at New York-Presbyterian Queens, and is an Assistant Professor of Clinical Neurology at Weill Cornell Medical College. He completed his neurology residency at Albert Einstein College of Medicine and a Stroke fellowship at Beth Israel Medical Center in New York City. He is board certified in Neurology and Vascular Neurology. He has been named a New York Magazine "Top Doctor" and has contributed to numerous NIH- and industry-funded multicenter stroke trials.`,
    credentials: ['Vascular Neurology', 'Weill Cornell Faculty'],
    location: 'New York',
    categories: ['neurology', 'stroke-vascular-neurology'],
  },
  {
...
Dr. Huh earned his medical degree from the Medical College of Georgia and his Bachelor of Arts in Neuroscience and Behavior from Columbia University. His expertise spans CT, MRI, and advanced neuroimaging, with particular focus on brain and spine pathology including stroke, hemorrhage, traumatic injury, tumor, and degenerative disease.`,
    credentials: [
      'Johns Hopkins Neuroradiology Fellowship',
      'Johns Hopkins Radiology Residency',
      'ABR Board Certified',
