...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative w-full py-16 lg:py-24 light-sky-bg overflow-hidden z-[90]"
    >
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-8">
              <div>
                ...
                <h2 className="display-heading text-display-lg text-navy mb-4">
                  SUBMIT A
                  <br />
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
                <p className="text-navy font-semibold text-sm mb-4 uppercase tracking-wider">
                  What Happens Next
                </p>
                  ...
                  {NEXT_STEPS.map((step, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-center gap-3">
                        <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-electric/10 flex-shrink-0">
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center gap-4 text-slate-700 hover:text-electric transition-colors group"
                >
                  <div className="w-12 h-12 rounded-xl bg-white border border-slate-200 group-hover:bg-electric/10 group-hover:border-electric/30 flex items-center justify-center transition-colors shadow-xs">
                    <Mail size={22} className="text-electric" />
                  </div>
                  <div>
                    <p className="text-sm text-slate-500">Email</p>
                    <p className="font-medium text-lg text-navy">{CONTACT_EMAIL}</p>
                  </div>
                </a>
                ...
                <div className="flex items-center gap-4 text-slate-700">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-navy">Available Nationwide</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="w-11 h-11 rounded-xl bg-white border border-slate-200 flex items-center justify-center hover:bg-electric hover:border-electric transition-colors shadow-xs group"
                >
                  <Linkedin size={20} className="text-slate-600 group-hover:text-white" />
                </a>
                <a
                  ...
                  className="w-11 h-11 rounded-xl bg-white border border-slate-200 flex items-center justify-center hover:bg-electric hover:border-electric transition-colors shadow-xs group"
                >
                  <Twitter size={20} className="text-slate-600 group-hover:text-white" />
                </a>
              </div>
            </div>
            ...
            {/* Form */}
            <div>
              <div className="bg-white rounded-3xl shadow-lg ring-1 ring-slate-200/70 p-6 lg:p-10">
                {submitted ? (
