/**
 * Homepage FAQ content. Kept in its own module (separate from the lazy-loaded
 * FAQSection component) so HomePage can statically import the data for FAQPage
 * JSON-LD without pulling the section component into the initial bundle.
 */
export const faqs = [
  {
